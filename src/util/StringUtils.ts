...
export interface IShortenOptions {
   ...
   *
   * @example
   * shorten('UserShoppingCart__order__market__director') // UsShCa__orde__mark__dire
   * `${shorten('UserShoppingCart__order__market')}_market_id` // UsShCa__orde__mark_market_id
   */
